...
class PengajuanKapController extends Controller
{
    ...
    public function store(Request $request, $is_bpkp, $frekuensi)
    {
        $validatedData = $request->validate([
            ...
            'keterangan_program_pembelajaran' => 'required',
        ...
        try {
            ...
            $pengajuanKapId = DB::table('pengajuan_kap')->insertGetId([
                ...
                'keterangan_program_pembelajaran' => $validatedData['keterangan_program_pembelajaran'],
    ...
    public function update(Request $request, $id, $is_bpkp, $frekuensi)
    {
        ...
        if ($pengajuanKap) {
            DB::table('pengajuan_kap')
                ...
                ->update([
                    ...
                    'keterangan_program_pembelajaran' => $validatedData['keterangan_program_pembelajaran'] ?? $pengajuanKap->keterangan_program_pembelajaran,
        ...
        // insert level_evaluasi_instrumen_kap
