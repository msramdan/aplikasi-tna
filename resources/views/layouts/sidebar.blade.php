            ...
            @canany([
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link collapsed {{ request()->routeIs('users*', 'roles*', 'jadwal-kap-tahunan*', 'activity-log*', 'setting-apps*') ? 'active' : '' }}"
                        ...
                        aria-expanded="{{ request()->routeIs('users*', 'roles*', 'jadwal-kap-tahunan*', 'activity-log*', 'setting-apps*') ? 'true' : 'false' }}"
                        aria-controls="sidebarUtilities">
                        <i class="fa fa-cogs"></i> <span data-key="t-forms">{{ __('sidebar.utilities') }}</span>
                    </a>
                    <div class="collapse menu-dropdown {{ request()->routeIs('users*', 'roles*', 'jadwal-kap-tahunan*', 'activity-log*', 'setting-apps*') ? 'show' : '' }}"
                        id="sidebarUtilities">
                        <ul class="nav nav-sm flex-column">
                            @can('user view')
                                <li class="nav-item">
